			...
			<div class="col-md-6">
				<section class="section sign-in inner-right-xs">
					...
					<div class="social-auth-buttons">
						<div class="row">
							<div class="col-md-4">
								<button id='login_qq' class="btn-block btn-lg btn btn-facebook"><i class="fa fa-qq"></i> QQ账号登录</button>
							</div>
							<div class="col-md-4">
								<button id='login_weibo' class="btn-block btn-lg btn btn-twitter"><i class="fa fa-weibo"></i> 新浪微博账号登录</button>
							</div>
							<div class="col-md-4">
								<button id='login_github' class="btn-block btn-lg btn btn-twitter"><i class="fa fa-github"></i> GitHub账号登录</button>
							</div>
						</div>
					</div>
